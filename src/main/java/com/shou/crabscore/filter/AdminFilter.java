...
@Log4j2
@WebFilter(urlPatterns = "/api/admin/*", filterName = "管理员用户组")
public class AdminFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) {
        ...
        if (!this.securityService.verify(jwt, CommonConstant.USER_TYPE_ADMIN, request).getCode().equals(CommonConstant.SUCCESS)) {
            try {
